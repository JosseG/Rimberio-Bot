...
namespace MyBotConversational.Dialog
{
    ...
    {
        private const string PromptMsgText = "Que fecha quiere registrar su cita?";
        private const string RepromptMsgText = "Vuelva a colocar la fecha en formato dd/mm/yyyy.";
